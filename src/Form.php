...
use Kevinbai\Admin\Form\Builder;
use Kevinbai\Admin\Form\Field;
use Kevinbai\Admin\Form\Field\File;
use Kevinbai\Admin\Form\NestedForm;
use Kevinbai\Admin\Form\Tab;
...
class Form
{
    ...
    {
        $map = [
            'button'            => \Kevinbai\Admin\Form\Field\Button::class,
            'checkbox'          => \Kevinbai\Admin\Form\Field\Checkbox::class,
            'color'             => \Kevinbai\Admin\Form\Field\Color::class,
            'currency'          => \Kevinbai\Admin\Form\Field\Currency::class,
            'date'              => \Kevinbai\Admin\Form\Field\Date::class,
            'dateRange'         => \Kevinbai\Admin\Form\Field\DateRange::class,
            'datetime'          => \Kevinbai\Admin\Form\Field\Datetime::class,
            'dateTimeRange'     => \Kevinbai\Admin\Form\Field\DatetimeRange::class,
            'datetimeRange'     => \Kevinbai\Admin\Form\Field\DatetimeRange::class,
            'decimal'           => \Kevinbai\Admin\Form\Field\Decimal::class,
            'display'           => \Kevinbai\Admin\Form\Field\Display::class,
            'divider'           => \Kevinbai\Admin\Form\Field\Divide::class,
            'divide'            => \Kevinbai\Admin\Form\Field\Divide::class,
            'editor'            => \Kevinbai\Admin\Form\Field\Editor::class,
            'email'             => \Kevinbai\Admin\Form\Field\Email::class,
            'embedsMany'        => \Kevinbai\Admin\Form\Field\EmbedsMany::class,
            'file'              => \Kevinbai\Admin\Form\Field\File::class,
            'hasMany'           => \Kevinbai\Admin\Form\Field\HasMany::class,
            'hidden'            => \Kevinbai\Admin\Form\Field\Hidden::class,
            'id'                => \Kevinbai\Admin\Form\Field\Id::class,
            'image'             => \Kevinbai\Admin\Form\Field\Image::class,
            'ip'                => \Kevinbai\Admin\Form\Field\Ip::class,
            'map'               => \Kevinbai\Admin\Form\Field\Map::class,
            'mobile'            => \Kevinbai\Admin\Form\Field\Mobile::class,
            'month'             => \Kevinbai\Admin\Form\Field\Month::class,
            'multipleSelect'    => \Kevinbai\Admin\Form\Field\MultipleSelect::class,
            'number'            => \Kevinbai\Admin\Form\Field\Number::class,
            'password'          => \Kevinbai\Admin\Form\Field\Password::class,
            'radio'             => \Kevinbai\Admin\Form\Field\Radio::class,
            'rate'              => \Kevinbai\Admin\Form\Field\Rate::class,
            'select'            => \Kevinbai\Admin\Form\Field\Select::class,
            'slider'            => \Kevinbai\Admin\Form\Field\Slider::class,
            'switch'            => \Kevinbai\Admin\Form\Field\SwitchField::class,
            'text'              => \Kevinbai\Admin\Form\Field\Text::class,
            'textarea'          => \Kevinbai\Admin\Form\Field\Textarea::class,
            'time'              => \Kevinbai\Admin\Form\Field\Time::class,
            'timeRange'         => \Kevinbai\Admin\Form\Field\TimeRange::class,
            'url'               => \Kevinbai\Admin\Form\Field\Url::class,
            'year'              => \Kevinbai\Admin\Form\Field\Year::class,
            'html'              => \Kevinbai\Admin\Form\Field\Html::class,
            'tags'              => \Kevinbai\Admin\Form\Field\Tags::class,
            'icon'              => \Kevinbai\Admin\Form\Field\Icon::class,
        ];
